...
async def present_proof_credentials_list(request: web.BaseRequest):
    ...
    try:
        ...
        indy_credentials = await holder.get_credentials_for_presentation_request_by_referent(
            indy_pres_request,
            pres_referents,
            start,
            count,
    ...
    try:    
        ...
        input_descriptors = dif_pres_request.get("presentation_definitions").get("input_descriptors")
        types = []
        contexts = []
        schema_ids = []
